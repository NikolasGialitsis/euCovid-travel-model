...
def expand_model(input_file_path, output_file_path):
  ...
  US_state_populations = {0:10768193	,1:60390560,2:7000039}

  #US_state_land_areas = make_model.process_travel_data.stateAreasLoad('state_land_area.txt')
  US_state_land_areas = {'GR':50940,'IT':116347,'BU':42855}
  ...
  print('abrev:',state_abrev_to_key)
  ...
  italy = [1/200,1/50,1/2000]*US_state_populations[state_abrev_to_key['IT']]
  greece = [1/10,1/10000,1/500]* US_state_populations[state_abrev_to_key['GR']]
  bulgaria = [1/100,1/400,1/150] * US_state_populations[state_abrev_to_key['BU']]
  state_fluxes = {0:[{0:greece[0],1:italy[0],2:bulgaria[0]},{0:greece[0],1:greece[1],2:greece[2]}],\
                  1:[{0:greece[1],1:italy[1],2:bulgaria[1]},{0:italy[0],1:italy[1],2:italy[2]}],\
                  2:[{0:greece[2],1:italy[2],2:bulgaria[2]},{0:bulgaria[0],1:bulgaria[1],2:bulgaria[2]}]}
